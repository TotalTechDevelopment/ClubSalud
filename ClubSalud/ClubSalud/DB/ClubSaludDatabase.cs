...
namespace ClubSalud.DB
{
    class ClubSaludDatabase
    {
        ...
        public void AddUser(User user)
        {
            ...
            dbUser.Codigo_Postal = user.Codigo_Postal;
            dbUser.Colonia = user.Colonia;
            dbUser.Calle = user.Calle;
            dbUser.Numero_Exterior = user.Numero_Exterior;
            ...
            dbUser.SpartanID = user.SpartanID;
            ...
            dbUser.Edad_del_Titular = user.Edad_del_Titular;
